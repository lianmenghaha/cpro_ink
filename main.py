...
for currentdir in listdir(svgdir):
    ...
    if os.path.isdir(curpath):
        ...
        action.cutSVG(svgdir + sep + currentdir, resultdir + sep + currentdir, no_merge_factor, lp_factor, deRectPaths)
# print("HIERHIEREHIERHIERHIERHIERHEIR____________________________DERECTPATHS")
...
for currentdir in listdir(resultdir):
    ...
    if os.path.isdir(curpath):
        ...
        action.extractObjects(resultdir + sep + currentdir, deRectPaths)
