...
#form chart_studio import tools
...
with open("/Users/LianMeng/Documents/CAI/C_PRO/heatmap/171130-MicroHeaterLayout-final/offwhite.png", "rb") as image_file:
...
for dir in dirs:
    ...
    for name in files:
        filep = p + sep + name
        df = pd.read_csv(filep,delim_whitespace = True, header=None, names=['x','y','time'], dtype={'time': np.float64, 'y': pd.Int32Dtype(), 'x': pd.Int32Dtype()})
